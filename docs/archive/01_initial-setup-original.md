# AMD Project - Initial Setup Scripts
...
# ==============================================================================
# FSI Stock Analysis & vLLM Benchmarking Setup Script (UV Optimized)
...
PROJECT_DIR="$HOME/fsi-stock-analysis-bench"
mkdir -p "$PROJECT_DIR"
cd "$PROJECT_DIR"
...
source ~/fsi-stock-analysis-bench/venv/bin/activate
